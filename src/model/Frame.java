...
public class Frame {
    ...
    private boolean iniciarJogo() {
        resposta = showConfirmDialog(jFrame, "Pense em um prato que goste", "Jogo Gourmet", OK_OPTION, INFORMATION_MESSAGE);
        return resposta == OK_OPTION;
    }
    
    // Perguntar para o usuário se essa característica pertence a comida escolhida
    private boolean perguntaCaracteristica(BinaryTree<String> bt) {
    ...
    private boolean perguntaComida(String str) {
        ...
        resposta = showConfirmDialog(jFrame, "Pense em um prato que goste", "Jogo Gourmet", YES_NO_OPTION, QUESTION_MESSAGE);
    ...
    */
    private String adicionaNovaComida() {
    ...
    */
    private String adicionaNovaCaracteristica(String novaComida, BinaryTree<String> antigaComida) {
